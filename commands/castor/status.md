...
- If READY: confirm the version, cache size, the available models and agents (both listed best-effort when shown), and — if shown — the last-index timestamp and git SHA for this project
